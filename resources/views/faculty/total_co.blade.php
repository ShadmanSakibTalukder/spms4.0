...
@section('content')
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('faculty.total.co.post') }}" method="POST">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-6 py-2">
                                        ...
                                        <input type="text" placeholder="Section" name="section" class="form-control">
                                    </div>
                                    <div class="col-6 py-2">
    ...
    <div>
        ...
        @endphp --}}
        <input type="hidden" value="{{ Session::get('grade') }}" id='mark_data'>
    </div>
@endsection
